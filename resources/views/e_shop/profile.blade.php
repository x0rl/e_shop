...
@section('content')
  ...
  <div class="center-block" style="width: 700px; margin:auto;">
    ...
    <form action = '{{ route('editAddress') }}' method = 'POST'>
      ...
      <div class="input-group mb-3">
        <span class="input-group-text" value='{{optional($address)->corp}}' name='corp' id="basic-addon1">Корпус</span>
        <input type="text" id='corpInput' class="form-control" placeholder="(необязательное поле)" aria-describedby="basic-addon1">
      </div>
